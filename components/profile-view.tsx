        ...
        <div className="card-3d w-full max-w-md bg-gradient-to-br from-secondary/70 via-secondary/60 to-secondary/50 backdrop-blur-xl rounded-2xl border border-border/50 p-8 shadow-2xl">
          <div className="flex flex-col items-center text-center gap-4">
            <Avatar className="h-24 w-24 border border-border/50 shadow-lg">
              <AvatarImage src="/diverse-avatars.png" alt="Profile picture" />
              <AvatarFallback className="bg-sidebar-accent text-foreground text-2xl font-semibold">AS</AvatarFallback>
            </Avatar>
            <div className="space-y-1">
              <h2 className="text-2xl font-semibold text-foreground font-[var(--font-heading)]">Aryan Sharma</h2>
          ...
          <div className="mt-8 space-y-3">
            <div className="flex items-center gap-3 rounded-xl border border-border/40 bg-background/30 px-4 py-3">
              ...
              <div className="text-left">
                ...
                <p className="text-sm font-medium text-foreground">Aryan Sharma</p>
              </div>
            </div>
            <div className="flex items-center gap-3 rounded-xl border border-border/40 bg-background/30 px-4 py-3">
              ...
              <div className="text-left">
                ...
                <p className="text-sm font-medium text-foreground">aryan.sharma@bitmesra.ac.in</p>
              </div>
            </div>
          </div>
        </div>
